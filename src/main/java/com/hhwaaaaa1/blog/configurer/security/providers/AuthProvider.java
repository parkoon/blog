...
import com.hhwaaaaa1.blog.configurer.security.tokens.PostAuthToken;
import com.hhwaaaaa1.blog.configurer.security.tokens.PreAuthToken;
import com.hhwaaaaa1.blog.configurer.security.utils.JwtDecoder;
import com.hhwaaaaa1.blog.utils.CommonUtils;
...
public class AuthProvider extends DaoAuthenticationProvider {
    ...
    public static List<SimpleGrantedAuthority> parseAuthorities(String userRole) {
        ...
        try {
            roles = CommonUtils.objectMapper.readValue(userRole, new TypeReference<List<Map<String, String>>>() {
            });
        } catch (IOException e) {
            e.printStackTrace();
        }
