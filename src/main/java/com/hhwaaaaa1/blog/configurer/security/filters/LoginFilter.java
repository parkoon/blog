package com.hhwaaaaa1.blog.configurer.security.filters;

import com.hhwaaaaa1.blog.configurer.security.models.LoginModel;
...
public class LoginFilter extends AbstractAuthenticationProcessingFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse) throws AuthenticationException, IOException, ServletException {
        LoginModel loginModel = CommonUtils.objectMapper.readValue(httpServletRequest.getReader(), LoginModel.class);
